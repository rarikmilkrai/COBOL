      ...
      * Date:20/03/23
      * Purpose:ESTRUTURAS DE REPETIÇÃO
      * Tectonics: cobc
      ******************************************************************
       IDENTIFICATION DIVISION.
       PROGRAM-ID. ESTRUTURADEREPETICAO.
       DATA DIVISION.
       ...
       P500-PROCESSA-2.
           ...
           PERFORM WITH TEST BEFORE UNTIL WS-COUNT = 3
       ...
       P500-FIM.
           P700-PROCESSA-3.
           PERFORM VARYING WS-IND FROM 1 BY UNTIL WS-IND GREATER 5
       ...
       P900-FINALIZA.
            ...
            STOP RUN.
       END PROGRAM ESTRUTURADEREPETICAO.
